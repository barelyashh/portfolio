...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' SSD at CAD+T ', " Mentor ", "Writer ",'Software Developer ', " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Yash Soni</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/barelyashh" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/yash-soni-7907331a9/" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/barelyashh" target="_blank">
          <AiOutlineInstagram />
        </a>
      </div>
