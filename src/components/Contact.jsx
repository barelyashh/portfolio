...
const Contact = () => {
  ...
  //         to_email: "yahs.soni4023@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:yashsoni4023@gmail.com" target="_blank" className="blue-text-gradient">yashsoni4023@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918878747770&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 8878747770
            </a>
          </article>
        </div>
